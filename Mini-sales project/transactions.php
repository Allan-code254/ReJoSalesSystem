...
// Start session to check if merchant is logged in
session_start();
...
// Fetch transactions belonging to the logged-in merchant
$stmt = $conn->prepare("SELECT sale_date, delivery_time, total_sales, profit, payment_status FROM transactions");
$stmt->execute();
